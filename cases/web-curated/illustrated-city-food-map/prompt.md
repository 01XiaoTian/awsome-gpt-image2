...
- Repository: [YouMind-OpenLab/awesome-gpt-image-2](https://github.com/YouMind-OpenLab/awesome-gpt-image-2)
- Gallery: [YouMind case 13515](https://youmind.com/gpt-image-2-prompts?id=13515)
- Original post: [@mm_zzm44854 on X](https://x.com/mm_zzm44854/status/2045861258520568230#reversed-1)
- Author: 皮皮特
- License: CC BY 4.0
...
The structured JSON-like prompt makes complex map requirements easier to control: landmarks, food spots, legend, mascot, border, and disclaimer are all separated.
